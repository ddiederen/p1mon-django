...
from history.models import HistoryUur,HistoryDag
...
# query set
qs1 = HistoryUur.objects.filter(timestamp__gte=datetime_query)
...
# drop columns
df1HistDay2.columns
df1HistDay2.drop(columns=['act_verbr_gas', 'act_verbr_kw_170', 'act_gelvr_kw_270',],inplace=True)

# drop first line with NAN values and incomplete last line
df1HistDay2 = df1HistDay2[1:-1]
...
print("Converted to history: days")