...
from history.models import HistoryMin,HistoryUur
...
# query set
qs1 = HistoryMin.objects.filter(timestamp__gte=datetime_query)
...
# drop columns
df1HistHour2.columns
df1HistHour2.drop(columns=['act_verbr_gas', 'act_verbr_kw_170', 'act_gelvr_kw_270',],inplace=True)

# drop first line with NAN values and incomplete last line
df1HistHour2 = df1HistHour2[1:-1]
...
print("Converted to history: hours")